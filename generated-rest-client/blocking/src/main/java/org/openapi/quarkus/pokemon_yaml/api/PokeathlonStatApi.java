...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedPokeathlonStatSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.PokeathlonStatDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "PokeathlonStat")
...
public interface PokeathlonStatApi {
    ...
    @GeneratedMethod ("pokeathlon_stat_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("pokeathlon_stat_retrieve")
