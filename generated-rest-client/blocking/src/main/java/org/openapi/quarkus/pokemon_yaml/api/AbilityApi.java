...
import org.openapi.quarkus.pokemon_yaml.model.AbilityDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedAbilitySummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "Ability")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("ability_retrieve")
