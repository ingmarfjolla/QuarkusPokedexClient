...
import org.openapi.quarkus.pokemon_yaml.model.EvolutionTriggerDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedEvolutionTriggerSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "EvolutionTrigger")
...
public interface EvolutionTriggerApi {
    ...
    @GeneratedMethod ("evolution_trigger_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("evolution_trigger_retrieve")
