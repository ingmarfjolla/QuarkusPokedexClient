...
import org.openapi.quarkus.pokemon_yaml.model.GenerationDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedGenerationSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "Generation")
...
public interface GenerationApi {
    ...
    @GeneratedMethod ("generation_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("generation_retrieve")
