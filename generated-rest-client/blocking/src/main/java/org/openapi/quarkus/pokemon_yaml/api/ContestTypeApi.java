...
import org.openapi.quarkus.pokemon_yaml.model.ContestTypeDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedContestTypeSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "ContestType")
...
public interface ContestTypeApi {
    ...
    @GeneratedMethod ("contest_type_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
     ...
     * Mixin to allow association with separate serializers for list or detail view.
     *
     * @param id A unique integer value identifying this contest type.
     */
    @GET
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("contest_type_retrieve")
