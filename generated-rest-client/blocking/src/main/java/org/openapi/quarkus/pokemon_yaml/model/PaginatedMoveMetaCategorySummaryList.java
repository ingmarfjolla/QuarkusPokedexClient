...
public class PaginatedMoveMetaCategorySummaryList  {
    ...
    private List<MoveMetaCategorySummary> results;
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PaginatedMoveMetaCategorySummaryListQueryParam  {
        ...
        **/
        ...
        public PaginatedMoveMetaCategorySummaryListQueryParam count(Integer count) {
            this.count = count;
            return this;
        }
        ...
        **/
        ...
        public PaginatedMoveMetaCategorySummaryListQueryParam next(URI next) {
            this.next = next;
            return this;
        }
        ...
        **/
        ...
        public PaginatedMoveMetaCategorySummaryListQueryParam previous(URI previous) {
            this.previous = previous;
            return this;
        }
        ...
        **/
        ...
        public PaginatedMoveMetaCategorySummaryListQueryParam results(List<MoveMetaCategorySummary> results) {
            this.results = results;
            return this;
        }
        public PaginatedMoveMetaCategorySummaryListQueryParam addResultsItem(MoveMetaCategorySummary resultsItem) {
            this.results.add(resultsItem);
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PaginatedMoveMetaCategorySummaryListQueryParam {\n");
