...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedVersionSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.VersionDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "Version")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("version_retrieve")
