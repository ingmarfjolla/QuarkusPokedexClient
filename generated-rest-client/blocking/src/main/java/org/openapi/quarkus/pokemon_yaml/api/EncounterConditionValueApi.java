...
import org.openapi.quarkus.pokemon_yaml.model.EncounterConditionValueDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedEncounterConditionValueSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "EncounterConditionValue")
...
public interface EncounterConditionValueApi {
    ...
    @GeneratedMethod ("encounter_condition_value_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("encounter_condition_value_retrieve")
