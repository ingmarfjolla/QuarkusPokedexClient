...
import org.openapi.quarkus.pokemon_yaml.model.MoveMetaAilmentDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedMoveMetaAilmentSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "MoveAilment")
...
public interface MoveAilmentApi {
    ...
    @GeneratedMethod ("move_ailment_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("move_ailment_retrieve")
