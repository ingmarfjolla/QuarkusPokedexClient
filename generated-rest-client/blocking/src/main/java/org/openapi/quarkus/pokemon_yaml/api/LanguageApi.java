...
import org.openapi.quarkus.pokemon_yaml.model.LanguageDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedLanguageSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "Language")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("language_retrieve")
