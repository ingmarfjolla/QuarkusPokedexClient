...
public class PaginatedItemCategorySummaryList  {
    ...
    private List<ItemCategorySummary> results;
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PaginatedItemCategorySummaryListQueryParam  {
        ...
        **/
        ...
        public PaginatedItemCategorySummaryListQueryParam count(Integer count) {
            this.count = count;
            return this;
        }
        ...
        **/
        ...
        public PaginatedItemCategorySummaryListQueryParam next(URI next) {
            this.next = next;
            return this;
        }
        ...
        **/
        ...
        public PaginatedItemCategorySummaryListQueryParam previous(URI previous) {
            this.previous = previous;
            return this;
        }
        ...
        **/
        ...
        public PaginatedItemCategorySummaryListQueryParam results(List<ItemCategorySummary> results) {
            this.results = results;
            return this;
        }
        public PaginatedItemCategorySummaryListQueryParam addResultsItem(ItemCategorySummary resultsItem) {
            this.results.add(resultsItem);
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PaginatedItemCategorySummaryListQueryParam {\n");
