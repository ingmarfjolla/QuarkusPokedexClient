...
import org.openapi.quarkus.pokemon_yaml.model.MoveMetaCategoryDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedMoveMetaCategorySummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "MoveCategory")
...
public interface MoveCategoryApi {
    ...
    @GeneratedMethod ("move_category_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("move_category_retrieve")
