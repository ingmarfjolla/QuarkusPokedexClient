...
import org.openapi.quarkus.pokemon_yaml.model.EggGroupDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedEggGroupSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "EggGroup")
...
public interface EggGroupApi {
    ...
    @GeneratedMethod ("egg_group_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("egg_group_retrieve")
