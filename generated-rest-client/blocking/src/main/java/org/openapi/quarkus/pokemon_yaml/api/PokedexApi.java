...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedPokedexSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.PokedexDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "Pokedex")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("pokedex_retrieve")
