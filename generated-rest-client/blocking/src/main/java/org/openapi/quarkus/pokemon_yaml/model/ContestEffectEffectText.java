...
public class ContestEffectEffectText  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class ContestEffectEffectTextQueryParam  {
        ...
        **/
        ...
        public ContestEffectEffectTextQueryParam effect(String effect) {
            this.effect = effect;
            return this;
        }
        ...
        **/
        ...
        public ContestEffectEffectTextQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class ContestEffectEffectTextQueryParam {\n");
