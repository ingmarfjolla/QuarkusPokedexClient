...
public class PaginatedLocationAreaSummaryList  {
    ...
    private List<LocationAreaSummary> results;
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PaginatedLocationAreaSummaryListQueryParam  {
        ...
        **/
        ...
        public PaginatedLocationAreaSummaryListQueryParam count(Integer count) {
            this.count = count;
            return this;
        }
        ...
        **/
        ...
        public PaginatedLocationAreaSummaryListQueryParam next(URI next) {
            this.next = next;
            return this;
        }
        ...
        **/
        ...
        public PaginatedLocationAreaSummaryListQueryParam previous(URI previous) {
            this.previous = previous;
            return this;
        }
        ...
        **/
        ...
        public PaginatedLocationAreaSummaryListQueryParam results(List<LocationAreaSummary> results) {
            this.results = results;
            return this;
        }
        public PaginatedLocationAreaSummaryListQueryParam addResultsItem(LocationAreaSummary resultsItem) {
            this.results.add(resultsItem);
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PaginatedLocationAreaSummaryListQueryParam {\n");
