...
public class AbilityChangeEffectText  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class AbilityChangeEffectTextQueryParam  {
        ...
        **/
        ...
        public AbilityChangeEffectTextQueryParam effect(String effect) {
            this.effect = effect;
            return this;
        }
        ...
        **/
        ...
        public AbilityChangeEffectTextQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class AbilityChangeEffectTextQueryParam {\n");
