...
import org.openapi.quarkus.pokemon_yaml.model.ItemFlingEffectDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedItemFlingEffectSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "ItemFlingEffect")
...
public interface ItemFlingEffectApi {
    ...
    @GeneratedMethod ("item_fling_effect_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("item_fling_effect_retrieve")
