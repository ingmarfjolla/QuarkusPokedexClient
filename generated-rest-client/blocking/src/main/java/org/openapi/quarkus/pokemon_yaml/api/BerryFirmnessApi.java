...
import org.openapi.quarkus.pokemon_yaml.model.BerryFirmnessDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedBerryFirmnessSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "BerryFirmness")
...
public interface BerryFirmnessApi {
    ...
    @GeneratedMethod ("berry_firmness_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("berry_firmness_retrieve")
