...
import org.openapi.quarkus.pokemon_yaml.model.MoveTargetDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedMoveTargetSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "MoveTarget")
...
public interface MoveTargetApi {
    ...
    @GeneratedMethod ("move_target_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("move_target_retrieve")
