...
public class MoveMetaCategoryDescription  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class MoveMetaCategoryDescriptionQueryParam  {
        ...
        **/
        ...
        public MoveMetaCategoryDescriptionQueryParam description(String description) {
            this.description = description;
            return this;
        }
        ...
        **/
        ...
        public MoveMetaCategoryDescriptionQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class MoveMetaCategoryDescriptionQueryParam {\n");
