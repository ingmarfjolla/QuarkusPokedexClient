...
public class PokedexDescription  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PokedexDescriptionQueryParam  {
        ...
        **/
        ...
        public PokedexDescriptionQueryParam description(String description) {
            this.description = description;
            return this;
        }
        ...
        **/
        ...
        public PokedexDescriptionQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PokedexDescriptionQueryParam {\n");
