...
public class MoveBattleStyleDetail  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class MoveBattleStyleDetailQueryParam  {
        ...
        **/
        ...
        public MoveBattleStyleDetailQueryParam name(String name) {
            this.name = name;
            return this;
        }
        ...
        **/
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class MoveBattleStyleDetailQueryParam {\n");
