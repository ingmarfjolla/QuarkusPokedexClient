...
import org.openapi.quarkus.pokemon_yaml.model.GenderDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedGenderSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "Gender")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("gender_retrieve")
