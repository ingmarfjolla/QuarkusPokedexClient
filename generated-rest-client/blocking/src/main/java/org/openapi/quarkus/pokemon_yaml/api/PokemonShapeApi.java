...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedPokemonShapeSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.PokemonShapeDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "PokemonShape")
...
public interface PokemonShapeApi {
    ...
    @GeneratedMethod ("pokemon_shape_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("pokemon_shape_retrieve")
