...
public class PokemonSpeciesDescription  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PokemonSpeciesDescriptionQueryParam  {
        ...
        **/
        ...
        public PokemonSpeciesDescriptionQueryParam description(String description) {
            this.description = description;
            return this;
        }
        ...
        **/
        ...
        public PokemonSpeciesDescriptionQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PokemonSpeciesDescriptionQueryParam {\n");
