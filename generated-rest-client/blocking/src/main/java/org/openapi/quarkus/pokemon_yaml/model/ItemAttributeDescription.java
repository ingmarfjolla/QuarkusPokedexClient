...
public class ItemAttributeDescription  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class ItemAttributeDescriptionQueryParam  {
        ...
        **/
        ...
        public ItemAttributeDescriptionQueryParam description(String description) {
            this.description = description;
            return this;
        }
        ...
        **/
        ...
        public ItemAttributeDescriptionQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class ItemAttributeDescriptionQueryParam {\n");
