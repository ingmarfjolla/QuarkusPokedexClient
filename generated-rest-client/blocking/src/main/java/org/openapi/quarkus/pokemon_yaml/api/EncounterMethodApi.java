...
import org.openapi.quarkus.pokemon_yaml.model.EncounterMethodDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedEncounterMethodSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "EncounterMethod")
...
public interface EncounterMethodApi {
    ...
    @GeneratedMethod ("encounter_method_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("encounter_method_retrieve")
