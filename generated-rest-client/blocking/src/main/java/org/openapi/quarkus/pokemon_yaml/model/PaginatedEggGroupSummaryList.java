...
public class PaginatedEggGroupSummaryList  {
    ...
    private List<EggGroupSummary> results;
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PaginatedEggGroupSummaryListQueryParam  {
        ...
        **/
        ...
        public PaginatedEggGroupSummaryListQueryParam count(Integer count) {
            this.count = count;
            return this;
        }
        ...
        **/
        ...
        public PaginatedEggGroupSummaryListQueryParam next(URI next) {
            this.next = next;
            return this;
        }
        ...
        **/
        ...
        public PaginatedEggGroupSummaryListQueryParam previous(URI previous) {
            this.previous = previous;
            return this;
        }
        ...
        **/
        ...
        public PaginatedEggGroupSummaryListQueryParam results(List<EggGroupSummary> results) {
            this.results = results;
            return this;
        }
        public PaginatedEggGroupSummaryListQueryParam addResultsItem(EggGroupSummary resultsItem) {
            this.results.add(resultsItem);
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PaginatedEggGroupSummaryListQueryParam {\n");
