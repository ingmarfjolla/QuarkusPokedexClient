...
public class PokemonHabitatDetail  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PokemonHabitatDetailQueryParam  {
        ...
        **/
        ...
        public PokemonHabitatDetailQueryParam name(String name) {
            this.name = name;
            return this;
        }
        ...
        **/
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PokemonHabitatDetailQueryParam {\n");
