...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedVersionGroupSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.VersionGroupDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "VersionGroup")
...
public interface VersionGroupApi {
    ...
    @GeneratedMethod ("version_group_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("version_group_retrieve")
