...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedPokemonSpeciesSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.PokemonSpeciesDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "PokemonSpecies")
...
public interface PokemonSpeciesApi {
    ...
    @GeneratedMethod ("pokemon_species_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("pokemon_species_retrieve")
