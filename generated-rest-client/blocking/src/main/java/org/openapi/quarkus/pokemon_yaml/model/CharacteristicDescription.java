...
public class CharacteristicDescription  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class CharacteristicDescriptionQueryParam  {
        ...
        **/
        ...
        public CharacteristicDescriptionQueryParam description(String description) {
            this.description = description;
            return this;
        }
        ...
        **/
        ...
        public CharacteristicDescriptionQueryParam language(LanguageSummary language) {
            this.language = language;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class CharacteristicDescriptionQueryParam {\n");
