...
public class EvolutionTriggerDetail  {
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class EvolutionTriggerDetailQueryParam  {
        ...
        **/
        ...
        public EvolutionTriggerDetailQueryParam name(String name) {
            this.name = name;
            return this;
        }
        ...
        **/
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class EvolutionTriggerDetailQueryParam {\n");
