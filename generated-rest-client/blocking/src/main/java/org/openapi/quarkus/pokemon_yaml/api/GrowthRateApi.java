...
import org.openapi.quarkus.pokemon_yaml.model.GrowthRateDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedGrowthRateSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "GrowthRate")
...
public interface GrowthRateApi {
    ...
    @GeneratedMethod ("growth_rate_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("growth_rate_retrieve")
