...
import org.openapi.quarkus.pokemon_yaml.model.ItemPocketDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedItemPocketSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "ItemPocket")
...
public interface ItemPocketApi {
    ...
    @GeneratedMethod ("item_pocket_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("item_pocket_retrieve")
