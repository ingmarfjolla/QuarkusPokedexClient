...
import org.openapi.quarkus.pokemon_yaml.model.MoveBattleStyleDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedMoveBattleStyleSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "MoveBattleStyle")
...
public interface MoveBattleStyleApi {
    ...
    @GeneratedMethod ("move_battle_style_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("move_battle_style_retrieve")
