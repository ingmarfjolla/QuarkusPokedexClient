...
import org.openapi.quarkus.pokemon_yaml.model.NatureDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedNatureSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "Nature")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("nature_retrieve")
