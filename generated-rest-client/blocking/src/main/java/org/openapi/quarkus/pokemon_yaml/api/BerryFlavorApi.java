...
import org.openapi.quarkus.pokemon_yaml.model.BerryFlavorDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedBerryFlavorSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "BerryFlavor")
...
public interface BerryFlavorApi {
    ...
    @GeneratedMethod ("berry_flavor_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("berry_flavor_retrieve")
