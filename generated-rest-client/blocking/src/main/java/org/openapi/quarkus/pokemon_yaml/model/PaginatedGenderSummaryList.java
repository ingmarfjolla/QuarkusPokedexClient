...
public class PaginatedGenderSummaryList  {
    ...
    private List<GenderSummary> results;
    ...
    **/
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class PaginatedGenderSummaryListQueryParam  {
        ...
        **/
        ...
        public PaginatedGenderSummaryListQueryParam count(Integer count) {
            this.count = count;
            return this;
        }
        ...
        **/
        ...
        public PaginatedGenderSummaryListQueryParam next(URI next) {
            this.next = next;
            return this;
        }
        ...
        **/
        ...
        public PaginatedGenderSummaryListQueryParam previous(URI previous) {
            this.previous = previous;
            return this;
        }
        ...
        **/
        ...
        public PaginatedGenderSummaryListQueryParam results(List<GenderSummary> results) {
            this.results = results;
            return this;
        }
        public PaginatedGenderSummaryListQueryParam addResultsItem(GenderSummary resultsItem) {
            this.results.add(resultsItem);
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class PaginatedGenderSummaryListQueryParam {\n");
