...
import org.openapi.quarkus.pokemon_yaml.model.LocationAreaDetail;
import org.openapi.quarkus.pokemon_yaml.model.PaginatedLocationAreaSummaryList;
...
@GeneratedClass(value="pokemon.yaml", tag = "LocationArea")
...
public interface LocationAreaApi {
    ...
    @GeneratedMethod ("location_area_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("location_area_retrieve")
