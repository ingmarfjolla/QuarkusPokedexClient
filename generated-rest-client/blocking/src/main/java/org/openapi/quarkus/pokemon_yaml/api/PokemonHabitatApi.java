...
import org.openapi.quarkus.pokemon_yaml.model.PaginatedPokemonHabitatSummaryList;
import org.openapi.quarkus.pokemon_yaml.model.PokemonHabitatDetail;
...
@GeneratedClass(value="pokemon.yaml", tag = "PokemonHabitat")
...
public interface PokemonHabitatApi {
    ...
    @GeneratedMethod ("pokemon_habitat_list")
...
, @GeneratedParam("offset") @QueryParam("offset") Integer offset
    ...
    @Path("/{id}/")
    @Produces({"application/json"})
    @GeneratedMethod ("pokemon_habitat_retrieve")
